...
До устранения ТД тесты находятся в нерабочем состоянии, т.к. интерфейсы менялись в процессе разработки. В части тестов отсутствовола необходимость. Некоторые тесты не работали либо работали неправильно.
